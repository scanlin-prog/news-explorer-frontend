    ...
    return (
        <>
            ...
            <header className={`header ${props.nav ? "header_theme_dark" : ""}`}>
                ...
                <Navigation nav={props.nav} logged={props.logged} handleLogin={props.handleLogin} handleLogout={props.handleLogout} classLinkLight={"navigation__link_current"}></Navigation>
