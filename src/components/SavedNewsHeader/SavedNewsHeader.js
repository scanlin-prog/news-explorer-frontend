    ...
    return (
        ...
        <div className={`saved-news-header-overlay ${props.nav ? "saved-news-header-overlay_visibility" : ""}`}></div>
            <header className={`saved-news-header ${props.nav ? "saved-news-header_theme_dark" : ""}`}>
                ...
                <Navigation nav={props.nav} logged={props.logged} classLink={'navigation__link_theme_dark'} classUser={'navigation__user_theme_dark'} classLinkDark={'navigation__link_current_theme_dark'} classIcon={'navigation__icon_theme_dark'}></Navigation>
